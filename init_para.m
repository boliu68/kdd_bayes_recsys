...
%for f1
para.h_a_vV1 = zeros(1, h);
para.h_b_vV1 = zeros(1, h);
para.a_vV = zeros(1,h);
para.b_vV = zeros(1,h);

%f2
para.h_a_vU2 = zeros(1,h);
para.h_b_vU2 = zeros(1,h);
para.a_vU = zeros(1,h);
para.b_vU = zeros(1,h);
...
%f5
para.h_a_gmacol5 = zeros(1,d);
para.h_b_gmacol5 = zeros(1,d);
para.a_gmacol = zeros(1,d);
para.b_gmacol = zeros(1,d);

%f6
para.h_a_gmarow6 = zeros(1,n);
para.h_b_gmarow6 = zeros(1,n);
para.a_gmarow = zeros(1,n);
para.b_gmarow = zeros(1,n);

%f7
para.h_m_b07 = zeros(1,L-1);
para.h_v_b07 = 10 * ones(1,L-1);
para.m_b0 = zeros(1,L-1);
para.v_b0 =zeros(1,L-1);
...
para.h_a_vV9 = zeros(1,h,d,h);
para.h_b_vV9 = zeros(1,h,d,h);
